<template>
  ...
  >
    <template v-slot:top>
      <v-toolbar flat>
        <v-toolbar-title class="text-capitalize">Vessel Schedule</v-toolbar-title>
...
export default {
  data: () => ({
    headers: [
      ...
      { text: " DATE", value: "arrival_date" },
      { text: " STATUS", value: "departure_status" },
      { text: "DEPART_DATE", value: "departure_date" },
    ],
    items: [],
  }),
  created() {
